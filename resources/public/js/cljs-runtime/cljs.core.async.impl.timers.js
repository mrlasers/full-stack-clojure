...
var i_37654 = (0);
while(true){
if((i_37654 < arr.length)){
(arr[i_37654] = null);

var G__37656 = (i_37654 + (1));
i_37654 = G__37656;
continue;
} else {
}
...
var i_37670 = (self__.level + (1));
while(true){
if((i_37670 <= (new_level + (1)))){
(update[i_37670] = self__.header);

var G__37678 = (i_37670 + (1));
i_37670 = G__37678;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_37681 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_37681[i]));
} else {
x__$2.forward.push((((i < links_37681.length))?(links_37681[i]):null));
}

if((i < links_37681.length)){
(links_37681[i] = x__$2);
} else {
links_37681.push(x__$2);
}
...
var i_37694 = (0);
while(true){
if((i_37694 <= self__.level)){
var links_37696 = (update[i_37694]).forward;
if((x__$1 === (((i_37694 < links_37696.length))?(links_37696[i_37694]):null))){
(links_37696[i_37694] = (x__$1.forward[i_37694]));

var G__37701 = (i_37694 + (1));
i_37694 = G__37701;
continue;
} else {
var G__37702 = (i_37694 + (1));
i_37694 = G__37702;
continue;
}
} else {
...
var G__37717 = nx;
var G__37718 = (level__$1 - (1));
x = G__37717;
level__$1 = G__37718;
continue;
} else {
var G__37719 = x;
var G__37720 = (level__$1 - (1));
x = G__37719;
level__$1 = G__37720;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__37740 = nx;
var G__37741 = (level__$1 - (1));
x = G__37740;
level__$1 = G__37741;
continue;
} else {
var G__37744 = x;
var G__37745 = (level__$1 - (1));
x = G__37744;
level__$1 = G__37745;
continue;
}
